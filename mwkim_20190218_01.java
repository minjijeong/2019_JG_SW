...
public class mwkim_20190218_01 {
	...
	static void valueChange(int aspect, boolean d) {
		...
		if(d) {		
			...
			cube[aspect][0][0] = temp[aspect][2][0];
			cube[aspect][0][1] = temp[aspect][1][0];
			cube[aspect][0][2] = temp[aspect][0][0];
			cube[aspect][1][2] = temp[aspect][0][1];
			cube[aspect][2][2] = temp[aspect][0][2];
			cube[aspect][2][1] = temp[aspect][1][2];
			cube[aspect][2][0] = temp[aspect][2][2];
			cube[aspect][1][0] = temp[aspect][2][1];
		}
		else {
			for(int i = 0; i < 4; i++) {
				int m = (i + 1) % 4;
			...
			cube[aspect][0][0] = temp[aspect][0][2];
			cube[aspect][0][1] = temp[aspect][1][2];
			cube[aspect][0][2] = temp[aspect][2][2];
			cube[aspect][1][2] = temp[aspect][2][1];
			cube[aspect][2][2] = temp[aspect][2][0];
			cube[aspect][2][1] = temp[aspect][1][0];
			cube[aspect][2][0] = temp[aspect][0][0];
			cube[aspect][1][0] = temp[aspect][0][1];
		}
	}
